...
CKEDITOR.lang[ 'eu' ] = {
	...
	common: {
		...
		cssLengthTooltip: 'Zenbakia bakarrik zehazten bada pixeletan exongo da. CSS neurri unitatea ere zehaztu ahal da (px, %, in, cm, mm, em, ex, pt, edo pc).',
